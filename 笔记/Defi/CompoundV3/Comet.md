...
contract Comet is CometMainInterface {
     ...
     */
    function getPackedAssetInternal(AssetConfig[] memory assetConfigs, uint256 i)
        internal
        view
        returns (uint256, uint256)
    {
        ...
        unchecked {
            ...
            uint256 word_a =
                (uint160(asset) << 0 | uint256(borrowCollateralFactor) << 160 | uint256(liquidateCollateralFactor)
                    << 176 | uint256(liquidationFactor) << 192);
        ...
        nonReentrant
    {
        ...
        if (reserves >= 0 && uint256(reserves) >= targetReserves) revert NotForSale();
     ...
     */
    function approveThis(address manager, address asset, uint256 amount) external override {
        if (msg.sender != governor) revert Unauthorized();
...
> 更新: 2025-11-25 19:21:16  
> 原文: <https://www.yuque.com/xiaoyuhushenfu/yzin4n/hkl3mev6mng35v2z>