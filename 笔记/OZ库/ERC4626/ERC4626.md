...
其中每份share的价格是 pricePerShare = totalAssets / totalSupply

## 存款

我们存入了assets数量的资产，我们需要给多少share

share = assets \* (1/pricePerShare)

## 赎回

用户通过 shares 取回资产（assets）：
...
（不用最新的数值进行deposit或者redeem操作）

totalAssets = 100 +20(赚的)
...
1 share → 120/100 = 1.2 asset

直接获得了0.2asset的资产

为了防止这种情况4626 里面要求用最新的数值进行更新
...
![1763285810926-2c4ab48b-9772-43ad-94fe-1fdc813debd1.png](./img/FLQpEx0LDtUGUN8Y/1763285810926-2c4ab48b-9772-43ad-94fe-1fdc813debd1-206345.png)

然后我们再赎回我们拿到手的share

![1763285856701-57165bb1-df5e-4d43-916e-6bb70c52a1c3.png](./img/FLQpEx0LDtUGUN8Y/1763285856701-57165bb1-df5e-4d43-916e-6bb70c52a1c3-591626.png)

这个样就会回跟刚存入的价格几乎一样


> 更新: 2025-11-17 19:29:40  
> 原文: <https://www.yuque.com/xiaoyuhushenfu/yzin4n/xggxs7lps5mmqg9g>